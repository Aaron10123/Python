...
def move_dinosaur():
    """移動恐龍"""
    global ds_y, jumpState, jumpValue, ds_index, ds_center_y, ds_center_x, ds_detect_r
    ...
    ds_detect_r = min(img_dinosaur[ds_index].get_height(),
                      img_dinosaur[ds_index].get_width()) / 2
...
def move_ptera():
    """移動翼龍"""
    global ptera_x, score, ptera_center_x, ptera_center_y, ptera_index
